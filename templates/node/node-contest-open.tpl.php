...
<div id="node-<?php print $node->nid; ?>" class="node node-contest-open <?php print $node_classes; ?>">
  <div class="inner">
    <div id="contest-banner">
      ...
      <div class="content-stats">
        ...
        <?php if(!$is_edit) { print showOpenContestDate($node); } ?>
      ...
      <div class="contest-state-wrapper">
        ...
        <?php if(!$is_edit){ print '<div class="open-contest-button">'.openContestButton($node,TRUE).'</div>'; } ?>
